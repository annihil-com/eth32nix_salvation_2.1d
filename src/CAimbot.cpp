...
void CAimbot::DoBulletBot(void)
{
	...
	//ETH32nix_2.1d UPDATE
        if(eth32.settings.aimtargetTextShow)
        ON_VISUALS Draw.TextCenter(target->screenX, target->screenY+20, 0.35, ".:.WARNING ENEMY.:.", colorRed, (target->visible) ? qfalse : qtrue, qtrue, GUI_FONT);
