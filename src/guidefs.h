	...
	******************************************************************* **/
	{
		...
		15,				// num controls
		{
			...
			{ CTRL_CHECKBOX,	"Show Text when aim target",	5,		18,		140,		8,		(int)&eth32.settings.aimtargetTextShow },
			{ CTRL_CHECKBOX,	"Draw Hackvisuals",		5,		31,		140,		8,		(int)&eth32.settings.drawHackVisuals },
			{ CTRL_CHECKBOX,	"Wallhack",			5,		44,		140,		8,		(int)&eth32.settings.wallhack },
			{ CTRL_CHECKBOX,	"Draw Scope Blackout",		5,		57,		140,		8,		(int)&eth32.settings.blackout },
			{ CTRL_CHECKBOX,	"Weapon Zoom",			5,		70,		140,		8,		(int)&eth32.settings.weaponZoom },
			{ CTRL_FLOATSLIDER,	"Scoped Turning",		5,		95,		140,		20,		SETFLOAT(0.1), SETFLOAT(1.0), (int)&eth32.settings.scopedTurnSpeed },
			{ CTRL_INTSLIDER,	"Smoke Visibility",		5,		120,		140,		20,		0, 100, (int)&eth32.settings.smoketrnsp },
			{ CTRL_FLOATSLIDER,	"Radar Range",			5,		145,		140,		20,		SETFLOAT(100), SETFLOAT(10000), (int)&eth32.settings.radarRange },
			{ CTRL_CHECKBOX,	"Banner",			5,		158,		140,		8,		(int)&eth32.settings.guiBanner },
			{ CTRL_FLOATSLIDER,	"Banner size",			5,		183,		140,		20,		SETFLOAT(0), SETFLOAT(3), (int)&eth32.settings.BannerScale },
			{ CTRL_CHECKBOX,	"Remove Foliage",		5,		196,		140,		8,		(int)&eth32.settings.removeFoliage },
			{ CTRL_CHECKBOX,	"Draw Warning Messages",	5,		209,		140,		8,		(int)&eth32.settings.showReload },
			{ CTRL_DROPBOX,		"Damage Indicator Type",	5,		234,		140,		23,		DMG_OFF, DMG_MAX-1, (int)&eth32.settings.dmgIndicator, (int)damageIndicatorText },
			{ CTRL_FLOATSLIDER,	"Dmg Arrow Size",		5,		259,		140,		20,		SETFLOAT(16), SETFLOAT(128), (int)&eth32.settings.dmgArrSize },
			{ CTRL_CHECKBOX,	"Remove Hit Particles",		5,		299,		140,		8,		(int)&eth32.settings.removeParticles },
		},
	},
