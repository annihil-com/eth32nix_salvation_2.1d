...
const static settingdef_t settingsDefs[] =
{
	...
	******************************************************************* **/
	...
	{ "AutoXVecsCalculation",			"true",			SETTING_BOOL,		(void*)&eth32.settings.autoVecX,
		 "enables autoVecX Calculation",
	},
	{ "AutoZVecsCalculation",			"true",			SETTING_BOOL,		(void*)&eth32.settings.autoVecZ,
		 "enables autoVecZ Calculation",
	},
	...
	******************************************************************* **/
	{ "orighud", 		"false", 		SETTING_BOOL, 		(void*)&eth32.settings.guiOriginal,
    	...
    	{ "aimtargetTextShow",			"true",			SETTING_BOOL,		(void*)&eth32.settings.aimtargetTextShow, 	//ETH32nix_2.1d
      "show text ENEMY when aim",
    	},
	...
	******************************************************************* **/
	...
	{ "pk3name",			"ETH32nix_2.1d.pk3",		SETTING_STRING,		(void*)eth32.settings.pk3file,
	...
	{ "cvarprefix",			"ETH32nix_2.1d_set",		SETTING_STRING,		(void*)eth32.settings.cvarPrefix,
