...
void CXmms2_ET_Init(){
    ...
    orig_Cmd_AddCommand("ImmoHooK_xmms2_play", &CXmms2_ET_Play);
    orig_Cmd_AddCommand("ImmoHooK_xmms2_stop", &CXmms2_ET_Stop);
    orig_Cmd_AddCommand("ImmoHooK_xmms2_next", &CXmms2_ET_Next);
    orig_Cmd_AddCommand("ImmoHooK_xmms2_prev", &CXmms2_ET_Prev);
    orig_Cmd_AddCommand("ImmoHooK_xmms2_info", &CXmms2_ET_Info);
}
